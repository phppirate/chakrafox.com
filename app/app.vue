<template>
    <Body style="background-color: #07152f">
        <Script
            type="text/partytown"
            defer
            data-site-id="chakrafox.com"
            src="https://assets.onedollarstats.com/tracker.js"
        />
        <div
            ref="container"
            class="w-full full-viewport-height text-white bg-[#07152F] flex items-center justify-center"
        >
            <ClientOnly>
                <div
                    class="flex flex-col items-center justify-center gap-12 mb-28"
                >
                    <div class="sr-only">
                        <h1>The Home of Chakra Fox</h1>
                        <p>
                            ChakraFox is a Ghost, a Specter, an Apparition, a
                            Silent Hunter. No Physical Presence… Formerly
                            Streaming on Twitch. Currently… no one knows.
                        </p>
                        <p>
                            He enjoys programming, hiking, playing guitar, and
                            more recently flying airplanes.
                        </p>
                    </div>
                    <div class="relative">
                        <div
                    ...
                    >
                        ...
                        >
                            <TooltipProvider>
                                <Tooltip>
                                    <TooltipContent
                                        >@vnm_chakrafox</TooltipContent
                                    >
                                    <TooltipTrigger as-child>
                                        <NuxtLink
                                            data-link
                                            to="https://x.com/vnm_chakrafox"
                                ...
                                <Tooltip>
                                    ...
                                    <TooltipTrigger as-child>
                                        <NuxtLink
                                            to="https://instagram.com/chakrafox"
                                            class="text-2xl hover:bg-accent hover:text-accent-foreground rounded-lg size-12 flex items-center justify-center"
                                        >
...
useSeoMeta({
    ...
    twitterDescription:
        "ChakraFox is a Ghost, a Specter, an Apparition, a Silent Hunter. No Physical Presence… Formerly Streaming on Twitch. Currently… no one knows. He enjoys programming, hiking, playing guitar, and more recently flying airplanes.",
